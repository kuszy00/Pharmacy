        ...
        public static async Task Initialize(StoreContext context, UserManager<User> userManager)
        {
            ...
            var products = new List<Product>
            {
                new Product
                {
                    ...
                    Description = "APAP to produkt leczniczy dla dorosłych i młodzieży w wieku powyżej 12 lat o działaniu przeciwbólowym i przeciwgorączkowym. 1 tabletka zawiera 500mg paracetamolu (Paracetamolum), który jest substancją czynną leku. Apap stosuje się w przypadku bólu o różnej etiologii jak np. głowy (w tym napięciowe bóle głowy), menstruacyjnego, zębów, mięśni, kostno-stawowego czy gardła. Wskazaniem do stosowania leku są również nerwobóle oraz gorączka, które występują np. podczas przeziębienia i grypy. Opakowanie leku Apap zawiera 50 sztuk podłużnych tabletek powlekanych w kolorze białym.",
                    Price = 16.99F,
                ...
                new Product
                {
                    ...
                    Description = "Voltaren Max 100 g jest lekiem w postaci żelu, którego substancją czynną jest diklofenak. Diklofenak należy do grupy niesteroidowych leków przeciwzapalnych (NLPZ). Żel przeciwbólowy Voltaren max przeznaczony jest do stosowania miejscowego na skórę. Lek redukuje stany zapalne oraz obrzęki występujące w okolicach mięśni i stawów, a także łagodzi ból.",
                    Price = 43.99F,
                ...
                new Product
                {
                    ...
                    Description = "SEMA Lab Witamina C 1000 mg to suplement diety o wysokiej zawartości witaminy C w formie kwasu L-askorbinowego. Każda kapsułka pozwala na dostarczenie do organizmu 1000 mg składnika aktywnego.",
                    Price = 3.99F,
                ...
                new Product
                {
                    ...
                    Description = "Hitaxa Fast to lek przeciwalergiczny, niewywołującym senności. Ułatwia kontrolę reakcji alergicznej oraz jej objawów. Hitaxa Fast łagodzi objawy związane z alergicznym zapaleniem błony śluzowej nosa (zapalenie błony śluzowej nosa spowodowane uczuleniem, na przykład katarem siennym lub uczuleniem na roztocza) u dorosłych i młodzieży w wieku 12 lat i starszych. Do objawów tego stanu zalicza się: kichanie, swędzenie lub wydzielinę z nosa, swędzenie podniebienia oraz swędzenie, zaczerwienienie lub łzawienie oczu.",
                    Price = 11.99F,
